...
| [10-autonomy-constraints.md](10-autonomy-constraints.md) | Ràng buộc tự chủ + Boss chỉ bàn luận (không override v1) |
| [11-boss-interrupt-flow.md](11-boss-interrupt-flow.md) | BossWake → 3 bên bàn → vẫn A+B + rails quyết định |
| [12-market-data-fetch.md](12-market-data-fetch.md) | Agents tự fetch snapshot; mắt vs não; LLMRuns đo chi phí |
...
| [diagrams/A06-d1-context-pipeline.mmd](diagrams/A06-d1-context-pipeline.mmd) | flowchart LR | Pipeline D1: Fetch D1 → Mắt swing → LLM não → Rails |
